package <%= appPackage %>.test.common;
...
import <%= appPackage %>.test.common.injection.component.DaggerTestComponent;
import <%= appPackage %>.test.common.injection.component.TestComponent;
